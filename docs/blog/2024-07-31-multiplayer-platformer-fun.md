...
description: Tech demo networking a platformer on Rune
...
In the second tech-demo, we look at making a platform game multiplayer using the Rune SDK. For anyone following along the base code is the same as the last [technical demo](https://developers.rune.ai/blog/top-down-synchronization), but we'll cover most of it in this article.
...
Let's get to the code. If you need directions on [creating a game project](https://developers.rune.ai/docs/quick-start) they're in the docs. In this demo we’re going to have a map and some players. So first let's declare some types to describe those:
...
If you have any questions or comments on the tech demo or Rune in general, be sure to join our [Discord](https://discord.gg/rune-ai).
