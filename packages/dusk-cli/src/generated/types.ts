...
export interface Mutation {
  ...
  dashboardMagicLink: DashboardMagicLinkPayload;
...
/** The root mutation type which contains root level fields which mutate data. */
export interface MutationDashboardMagicLinkArgs {
...
export type GameQuery = { __typename: 'Query', gameById: { __typename: 'Game', id: number, title: string, description: string | null, createdAt: string, gameDevs: { __typename: 'GameDevsConnection', nodes: Array<{ __typename: 'GameDev', userId: number, displayName: string | null, type: GameDevType }> }, gameVersions: { __typename: 'GameVersionsConnection', nodes: Array<{ __typename: 'GameVersion', gameId: number, gameVersionId: number, status: GameVersionStatus }> } } | null };

export type GamesQueryVariables = Exact<{ [key: string]: never; }>;


export type GamesQuery = { __typename: 'Query', games: { __typename: 'GamesConnection', nodes: Array<{ __typename: 'Game', id: number, title: string, description: string | null, gameDevs: { __typename: 'GameDevsConnection', nodes: Array<{ __typename: 'GameDev', userId: number, displayName: string | null, type: GameDevType }> }, gameVersions: { __typename: 'GameVersionsConnection', nodes: Array<{ __typename: 'GameVersion', gameId: number, gameVersionId: number, status: GameVersionStatus }> } }> } | null };
...
export type InviteGameDevMutation = { __typename: 'Mutation', inviteGameDev: { __typename: 'InviteGameDevPayload', clientMutationId: string | null } };

export type DashboardMagicLinkMutationVariables = Exact<{
  input: DashboardMagicLinkInput;
}>;


export type DashboardMagicLinkMutation = { __typename: 'Mutation', dashboardMagicLink: { __typename: 'DashboardMagicLinkPayload', clientMutationId: string | null, dashboardMagicLink: string } };
...
export type UpdateGameDevMutation = { __typename: 'Mutation', updateGameDev: { __typename: 'UpdateGameDevPayload', clientMutationId: string | null } };
...
export type DashboardMagicLinkPayloadKeySpecifier = ('clientMutationId' | 'dashboardMagicLink' | DashboardMagicLinkPayloadKeySpecifier)[];
export type DashboardMagicLinkPayloadFieldPolicy = {
	clientMutationId?: FieldPolicy<any> | FieldReadFunction<any>,
	dashboardMagicLink?: FieldPolicy<any> | FieldReadFunction<any>
};
export type GameKeySpecifier = ('appId' | 'blurredImgDataUrl' | 'commentCount' | 'createdAt' | 'description' | 'gameDevs' | 'gameVersions' | 'id' | 'isAllowedInsideRoom' | 'logoUrl' | 'playTime' | 'players' | 'plays' | 'previewImgUrl' | 'title' | 'type' | 'updatedAt' | GameKeySpecifier)[];
...
export type GameDevKeySpecifier = ('displayName' | 'game' | 'gameId' | 'status' | 'type' | 'userId' | 'userProfileEditable' | GameDevKeySpecifier)[];
...
export type GameDevsConnectionKeySpecifier = ('edges' | 'nodes' | 'pageInfo' | 'totalCount' | GameDevsConnectionKeySpecifier)[];
...
export type GameDevsEdgeKeySpecifier = ('cursor' | 'node' | GameDevsEdgeKeySpecifier)[];
export type GameDevsEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
export type GameVersionKeySpecifier = ('createdByDevId' | 'game' | 'gameId' | 'gameVersionId' | 'key' | 'landscape' | 'multiplayerMaxPlayers' | 'multiplayerMinPlayers' | 'multiplayerSupportsPlayerJoining' | 'multiplayerSupportsPlayerLeaving' | 'persistPlayerData' | 'sdkVersion' | 'status' | 'updatesPerSecond' | 'usesUpdates' | GameVersionKeySpecifier)[];
...
export type InviteGameDevPayloadKeySpecifier = ('clientMutationId' | InviteGameDevPayloadKeySpecifier)[];
...
export type MutationKeySpecifier = ('checkVerification' | 'createGame' | 'createGameVersion' | 'dashboardMagicLink' | 'inviteGameDev' | 'requestPayout' | 'startVerification' | 'updateGame' | 'updateGameDev' | 'updateGameSdk' | MutationKeySpecifier)[];
...
export type QueryKeySpecifier = ('gameByAppId' | 'gameById' | 'gameVersionByGameIdAndGameVersionId' | 'gameVersionByKey' | 'gameVersions' | 'games' | 'me' | 'query' | 'userDevByUserId' | 'userDevs' | 'userPrivateReadonlies' | 'userPrivateReadonlyByEmail' | 'userPrivateReadonlyByUserId' | 'userProfileEditableByUserId' | 'userProfileEditables' | QueryKeySpecifier)[];
...
export type RequestPayoutPayloadKeySpecifier = ('clientMutationId' | RequestPayoutPayloadKeySpecifier)[];
...
export type UpdateGameDevPayloadKeySpecifier = ('clientMutationId' | UpdateGameDevPayloadKeySpecifier)[];
...
export type UserDevKeySpecifier = ('badge' | 'createdAt' | 'updatedAt' | 'userId' | UserDevKeySpecifier)[];
...
export type UserDevsConnectionKeySpecifier = ('edges' | 'nodes' | 'pageInfo' | 'totalCount' | UserDevsConnectionKeySpecifier)[];
...
export type UserDevsEdgeKeySpecifier = ('cursor' | 'node' | UserDevsEdgeKeySpecifier)[];
export type UserDevsEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserPrivateReadonliesConnectionKeySpecifier = ('edges' | 'nodes' | 'pageInfo' | 'totalCount' | UserPrivateReadonliesConnectionKeySpecifier)[];
...
export type UserPrivateReadonliesEdgeKeySpecifier = ('cursor' | 'node' | UserPrivateReadonliesEdgeKeySpecifier)[];
export type UserPrivateReadonliesEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserPrivateReadonlyKeySpecifier = ('email' | 'userId' | UserPrivateReadonlyKeySpecifier)[];
export type UserPrivateReadonlyFieldPolicy = {
	email?: FieldPolicy<any> | FieldReadFunction<any>,
	userId?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserProfileEditableKeySpecifier = ('displayName' | 'userId' | UserProfileEditableKeySpecifier)[];
export type UserProfileEditableFieldPolicy = {
	displayName?: FieldPolicy<any> | FieldReadFunction<any>,
	userId?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserProfileEditablesConnectionKeySpecifier = ('edges' | 'nodes' | 'pageInfo' | 'totalCount' | UserProfileEditablesConnectionKeySpecifier)[];
...
export type UserProfileEditablesEdgeKeySpecifier = ('cursor' | 'node' | UserProfileEditablesEdgeKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	DashboardMagicLinkPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | DashboardMagicLinkPayloadKeySpecifier | (() => undefined | DashboardMagicLinkPayloadKeySpecifier),
	...
	GameDevsEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | GameDevsEdgeKeySpecifier | (() => undefined | GameDevsEdgeKeySpecifier),
	...
	InviteGameDevPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InviteGameDevPayloadKeySpecifier | (() => undefined | InviteGameDevPayloadKeySpecifier),
	...
	RequestPayoutPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RequestPayoutPayloadKeySpecifier | (() => undefined | RequestPayoutPayloadKeySpecifier),
	...
	UpdateGameDevPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UpdateGameDevPayloadKeySpecifier | (() => undefined | UpdateGameDevPayloadKeySpecifier),
	...
	UserDev?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserDevKeySpecifier | (() => undefined | UserDevKeySpecifier),
		fields?: UserDevFieldPolicy,
	},
	UserDevsConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserDevsConnectionKeySpecifier | (() => undefined | UserDevsConnectionKeySpecifier),
		fields?: UserDevsConnectionFieldPolicy,
	},
	UserDevsEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserDevsEdgeKeySpecifier | (() => undefined | UserDevsEdgeKeySpecifier),
		fields?: UserDevsEdgeFieldPolicy,
	},
	UserPrivateReadonliesConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserPrivateReadonliesConnectionKeySpecifier | (() => undefined | UserPrivateReadonliesConnectionKeySpecifier),
		fields?: UserPrivateReadonliesConnectionFieldPolicy,
	},
	UserPrivateReadonliesEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserPrivateReadonliesEdgeKeySpecifier | (() => undefined | UserPrivateReadonliesEdgeKeySpecifier),
		fields?: UserPrivateReadonliesEdgeFieldPolicy,
	},
	UserPrivateReadonly?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserPrivateReadonlyKeySpecifier | (() => undefined | UserPrivateReadonlyKeySpecifier),
		fields?: UserPrivateReadonlyFieldPolicy,
	},
	UserProfileEditable?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserProfileEditableKeySpecifier | (() => undefined | UserProfileEditableKeySpecifier),
		fields?: UserProfileEditableFieldPolicy,
	},
	UserProfileEditablesConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserProfileEditablesConnectionKeySpecifier | (() => undefined | UserProfileEditablesConnectionKeySpecifier),
		fields?: UserProfileEditablesConnectionFieldPolicy,
	},
	UserProfileEditablesEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserProfileEditablesEdgeKeySpecifier | (() => undefined | UserProfileEditablesEdgeKeySpecifier),
...
export const InviteGameDevDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"InviteGameDev"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"InviteGameDevInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inviteGameDev"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}}]}}]}}]} as unknown as DocumentNode<InviteGameDevMutation, InviteGameDevMutationVariables>;
export const DashboardMagicLinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DashboardMagicLink"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DashboardMagicLinkInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dashboardMagicLink"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}},{"kind":"Field","name":{"kind":"Name","value":"dashboardMagicLink"}}]}}]}}]} as unknown as DocumentNode<DashboardMagicLinkMutation, DashboardMagicLinkMutationVariables>;
...
export const UpdateGameDevDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateGameDev"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateGameDevInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateGameDev"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clientMutationId"}}]}}]}}]} as unknown as DocumentNode<UpdateGameDevMutation, UpdateGameDevMutationVariables>;
