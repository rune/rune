...
export type DashboardMagicLinkQuery = { __typename: 'Query', dashboardMagicLink: string };
...
export type MutationKeySpecifier = ('checkVerification' | 'createGame' | 'createGameVersion' | 'inviteGameDev' | 'requestPayout' | 'startVerification' | 'updateGame' | 'updateGameDev' | 'updateGameSdk' | MutationKeySpecifier)[];
...
export type QueryKeySpecifier = ('dashboardMagicLink' | 'gameByAppId' | 'gameById' | 'gameVersionByGameIdAndGameVersionId' | 'gameVersionByKey' | 'gameVersions' | 'games' | 'me' | 'query' | 'userDevByUserId' | 'userDevs' | 'userPrivateReadonlies' | 'userPrivateReadonlyByEmail' | 'userPrivateReadonlyByUserId' | 'userProfileEditableByUserId' | 'userProfileEditables' | QueryKeySpecifier)[];
...
export const DashboardMagicLinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DashboardMagicLink"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dashboardMagicLink"}}]}}]} as unknown as DocumentNode<DashboardMagicLinkQuery, DashboardMagicLinkQueryVariables>;
