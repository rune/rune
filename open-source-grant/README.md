...
1. **Apply:** Fill out the [application form](https://joinrune.notion.site/23b0537d890581f188bbfdbaead2ce21?pvs=143) before the deadline with a new game idea or an existing game
...
The deadline for applying for an open-source grant was February 7th. We will open again for another round of grant applications again sometime later in 2024. Stay tuned by giving this repo a star and joining the [Rune Discord](https://discord.gg/rune-ai).
...
We'd love to answer any questions. Please write your question in the **#general** channel in our [Discord server](https://discord.gg/rune-ai).
