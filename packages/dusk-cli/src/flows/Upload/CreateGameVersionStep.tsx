          ...
          createGameVersionLoading ? (
            ...
            formatApolloError(createGameVersionError, {
              "[tango][GAME_VALIDATION_FAILED]":
                "Game validation failed. Make sure you are using latest CLI version. If the validation still fails after updating, then please write us in the Dusk Discord server: https://discord.gg/rune-devs",
            ...
            <>
              ...
              <Newline />
              You can also test your game in the Dusk app.
              {shouldPostToDiscord && (
                <>
                  <Newline />
                  <Text color="blue">
                    Check Discord #game-launch channel for feedback from Dusk
                    and other game devs!
                  </Text>
                </>
              )}
